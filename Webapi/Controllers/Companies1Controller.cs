...
namespace Webapi.Controllers
{
    public class Companies1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CompanyName,location")] Company company)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CompanyName,location")] Company company)
        {
            if (ModelState.IsValid)
            {
